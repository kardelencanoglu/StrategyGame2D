...
public class CheckingPlacementBarracks : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        buildSprite = Resources.Load<Sprite>("BuildBarracks");
        cantBuildSprite = Resources.Load<Sprite>("CantBuildBarracks");
